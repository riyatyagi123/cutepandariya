...
API_URL = os.getenv("DEEPINFRA_API_URL", "https://api.deepinfra.com/v1/openai/chat/completions")
API_TOKEN = os.getenv("DEEPINFRA_TOKEN")
MODEL_NAME = os.getenv("LLAMA_MODEL", "meta-llama/Llama-4-Scout-17B-16E-Instruct")
...
def community_posts():
    ...
    try:
        ...
        # log the exception server-side (print will show in your terminal)
